      ...
      <>
        <form onSubmit={this.handleSubmit}>
          ...
          <input
            type="number"
            id="numVotesAllowed"
            name="numVotesAllowed"
            value={numVotesAllowed}
            onChange={this.handleChange}
            readOnly={!isEditable}
          />
          <br />
          ...
          <input
            type="number"
            id="maxNumCandidates"
            name="maxNumCandidates"
            value={maxNumCandidates}
            onChange={this.handleChange}
            readOnly={!isEditable}
          />
          <br />
        ...
        <div>
          ...
          {/* Status button */}
          {isWithinDateRange && (
            <button type="button" onClick={this.handleStatusClick}>
              Status
            </button>
          )}
          {/* Results button */}
          {isAfterEndDate && (
            <button type="button" onClick={this.handleResultsClick}>
              Results
            </button>
          )}
